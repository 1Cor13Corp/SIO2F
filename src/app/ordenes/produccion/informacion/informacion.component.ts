...
export class InformacionComponent {
  ...
  const base64Image = await loadImageAsBase64('../../assets/poli_cintillo.png');
    ...
    pdf.add(
      new Table([
        [
          ...
          new Cell(new Txt(`
                SOLICITUD DE MATERIAL`).bold().end).alignment('center').fontSize(11).rowSpan(4).end,
    ...
    pdf.add(
      new Table([
        ...
        [
          ...
          new Cell(new Txt(`AL-ASG-25-001`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`AL-DEV-${devolucion.numero}`).alignment('center').fontSize(18).bold().end).margin([0, -3, 0, -3]).border([true, false, true, false]).end
        ],
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    pdf.add(
      new Table([
        ...
        [
          new Cell(new Txt(`${devolucion.op.numero_op}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`${devolucion.op.producto[0].identificacion.producto}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`${formatearFecha(devolucion.createdAt)}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
        ],
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    pdf.add(
      new Table([
        [
          new Cell(new Txt('DESCRIPCIÓN DE LA DEVOLUCIÓN').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
        ]
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    for (let i = 0; i < devolucion.material.length; i++) {
      ...
      materiales.push(
        [
          new Cell(new Txt(devolucion.material[i].material.material.nombre).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt('Vitamax').fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(devolucion.material[i].material.codigo).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(devolucion.material[i].material.lote).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[false, false, true, false] : [false, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(devolucion.material[i].cantidad).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false]: [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end, 
        ]
      )
    }
    ...
    pdf.add(
      ...
      pdf.add(
        new Table([
          [
            ...
            new Cell(new Txt('MOTIVO').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
            new Cell(new Txt('DEVUELTO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
            new Cell(new Txt('RECIBIDO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
          ],
          [
          ...
          [
            ...
            new Cell(new Txt('Freddy Burgos').fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, false]).end,
            new Cell(new Txt('Yraida Baptista').fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, false]).end,
          ],
          [
            new Cell(new Txt('').fontSize(11).end).border([true, false, true, false]).end,
          ...
          [
            ...
            new Cell(new Txt('18/03/2025 - 10:56 am').fontSize(9).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
            new Cell(new Txt('18/03/2025 - 10:56 am').fontSize(9).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          ]
        ])
          .layout({
      ...
      pdf.add(
        new Table([
          [
            ...
            new Cell(new Txt('VERIFICACIÓN FÍSICA').alignment('center').bold().fontSize(9).color('#FFFFFF').end).colSpan(2).fillColor('#a5acb2').end,
            new Cell(new Txt('').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
          ],
          [
  
            new Cell(new Txt('').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).end,
            new Cell(new Txt('DEVUELTO POR').alignment('center').fontSize(7).end).fillColor('#F2F2F2').border([true,false,true, false]).end,
            new Cell(new Txt('RECIBIDO POR').alignment('center').fontSize(7).end).fillColor('#F2F2F2').border([true,false,true, false]).end,
          ],
          [
            new Cell(new Txt('').fontSize(11).end).border([false, false, false, false]).end,            
            new Cell(new Txt(`NOMBRE:
              
              `).fontSize(5.7).end).border([true, false, true, false]).end,
            new Cell(new Txt(`NOMBRE:
          ...
          [
            ...
            new Cell(new Txt(`
              ...
              `).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, false]).end,
            new Cell(new Txt(`
          ...
          [
            ...
            new Cell(new Txt(`FECHA:            /               /
              ...
              HORA:`).fontSize(5.7).end).border([true, false, true, true]).end,
            new Cell(new Txt(`FECHA:            /               /
        ...
        pdf.add(
          new Txt('"Si usted está consultando una versión de este documento, asegúrese que sea la vigente."').fontSize(6.5).alignment('center').end
        )
      ...
      pdf.footer((currentPage, pageCount) => {
        return new Table([
          [
            new Cell(
              new Txt(`ID: 67e2b1a475a1fd4fe9393386`).fontSize(6).end
            ).border([false]).end,
            new Cell(
              new Txt(`Impreso por: ${this.usuario.usuario.Nombre} ${this.usuario.usuario.Apellido} - ${getFormattedDate()}`)
                .fontSize(6)
                .alignment('right')
                .end
            ).border([false]).end
  ...
  async generarSolicitud(solicitud) {
    ...
    pdf.add(
      new Table([
        ...
        [
          new Cell(new Txt(`PRODUCCIÓN`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`AL-SOL-${solicitud.numero}`).alignment('center').fontSize(18).bold().end).margin([0, -3, 0, -3]).border([true, false, true, false]).end
        ],
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    pdf.add(
      new Table([
        ...
        [
          new Cell(new Txt(`${solicitud.op.numero_op}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`${solicitud.op.producto[0].identificacion.producto}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
          new Cell(new Txt(`${formatearFecha(solicitud.createdAt)}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
        ],
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    pdf.add(
      new Table([
        [
          new Cell(new Txt('DESCRIPCIÓN DE LA SOLICITUD').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
        ]
      ])
        .layout({
          hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    for (let i = 0; i < solicitud.materiales.length; i++) {
      ...
      materiales.push(
        [
          new Cell(new Txt(solicitud.materiales[i].material.nombre).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt('Vitamax').fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(solicitud.materiales[i].cantidad).fontSize(9).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false]: [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end, 
        ]
      )
    }
      ...
      pdf.add(
        new Table([
          [
            ...
            new Cell(new Txt('MOTIVO').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
            new Cell(new Txt('SOLICITADO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
            new Cell(new Txt('RECIBIDO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
          ],
          [
            new Cell(new Txt('').fontSize(11).end).border([true, false, true, false]).end,            
      ...
      pdf.footer((currentPage, pageCount) => {
        return new Table([
          [
            ...
            new Cell(
              new Txt(`Impreso por: ${this.usuario.usuario.Nombre} ${this.usuario.usuario.Apellido} - ${getFormattedDate()} - ${currentPage}/${pageCount}`)
                .fontSize(6)
                .alignment('right')
                .end
            ).border([false]).end
  ...
  async generarAsignacion(asignacion) {
        ...
        stack: [
          ...
          new Table([
            [
              ...
              new Cell(new Txt(`
                ASIGNACIÓN DE MATERIAL`).bold().end).alignment('center').fontSize(11).rowSpan(4).end,
              new Cell(new Txt('Código: FPR-008').end).fillColor('#dedede').fontSize(5).alignment('center').end,
            ],
            [
              new Cell(new Txt('').end).end,
            ...
            [
              new Cell(new Txt('').end).end,
              new Cell(new Txt('').end).end,
              new Cell(new Txt('Fecha de Revisión: 12/03/2025').end).fillColor('#dedede').fontSize(5).alignment('center').end,
            ],
            [
              new Cell(new Txt('').end).end,
              new Cell(new Txt('').end).end,
              new Cell(new Txt(`Página: ${currentPage} de ${pageCount}`).end).fillColor('#dedede').fontSize(5).alignment('center').end,
            ],
          ])
            .layout({
              hLineWidth: () => 0.5,
            ...
            new Table([
              ...
              [
                new Cell(new Txt(`PRODUCCIÓN`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
                new Cell(new Txt(`AL-SOL-${asignacion.solicitud}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
                new Cell(new Txt(`AL-ASG-${asignacion.numero}`).alignment('center').fontSize(18).bold().end).margin([0, -3, 0, -3]).border([true, false, true, false]).end
              ],
            ])
              .layout({
                hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
              ...
              new Table([
                ...
                [
                  new Cell(new Txt(`${asignacion.op.numero_op}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
                  new Cell(new Txt(`${asignacion.op.producto[0].identificacion.producto}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
                  new Cell(new Txt(`${formatearFecha(asignacion.createdAt)}`).fontSize(11).end).margin([0, -3, 0, 0]).border([true, false, true, true]).end,
                ],
              ])
                .layout({
                  hLineWidth: (rowIndex?: number, node?: any, columnIndex?: number) => 0.5,
    ...
    for (let i = 0; i < asignacion.material.length; i++) {
      ...
      materiales.push(
        [
          new Cell(new Txt(asignacion.material[i].material.material.nombre).fontSize(13).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt('Vitamax').fontSize(13).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(asignacion.material[i].material.codigo).fontSize(13).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false] : [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(asignacion.material[i].material.lote).fontSize(13).end).margin([0, 0, 0, 0]).border(i != l ?[false, false, true, false] : [false, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end,
          new Cell(new Txt(asignacion.material[i].cantidad).fontSize(13).end).margin([0, 0, 0, 0]).border(i != l ?[true, false, true, false]: [true, false, true, true]).fillColor(i % 2 === 0 ? '#F2F2F2' : '#FFFFFF').end, 
        ]
      )
    }
    ...
    pdf.add(
      ...
      new Table([
        [
           ...
           new Cell(new Txt('').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).end,
           new Cell(new Txt('ASIGNADO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
           new Cell(new Txt('RECIBIDO POR').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
         ],
         [
         ...
         .layout({
           ...
           hLineColor: (rowIndex?: number, node?: any, columnIndex?: number) => '#555',
           vLineColor: (rowIndex?: number, node?: any, columnIndex?: number) => '#555',
         }).margin([39,0,39,0]).widths(['60%', '20%', '20%']).end,
        new Txt(' ').fontSize(10).end,
        new Stack([
          new Table([
            [
            ...
            [
             ...
             new Cell(new Txt('').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).end,
             new Cell(new Txt('ASIGNADO POR').alignment('center').fontSize(7).end).fillColor('#F2F2F2').border([true,false,true, false]).end,
             new Cell(new Txt('RECIBIDO POR').alignment('center').fontSize(7).end).fillColor('#F2F2F2').border([true,false,true, false]).end,
           ],
           [
             new Cell(new Txt('').fontSize(11).end).border([false, false, false, false]).end,            
